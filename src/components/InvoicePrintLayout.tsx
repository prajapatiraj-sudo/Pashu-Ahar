...
export default function InvoicePrintLayout({ 
  ...
  return (
      <div className="bg-white p-4 md:p-10 text-black font-gujarati w-[210mm] mx-auto min-h-[297mm] flex flex-col border border-black/10 print:border-0 print:m-0 print:p-[5mm] print:w-[200mm] print:min-h-0 print:mx-auto">
        {/* Header */}
        ...
        <div className="text-center mb-2">
          <h1 className="text-6xl font-black text-[#dc2626] mb-1 tracking-tighter" style={{ color: '#dc2626', WebkitPrintColorAdjust: 'exact' }}>કૃષ્ણમ પશુ આહાર</h1>
        ...
        {/* Invoice Info */}
        <div className="grid grid-cols-2 gap-8 mb-2 mt-1">
        ...
        {/* Footer */}
        <div className="mt-4">
          <div className="border-[3px] border-black p-3 rounded-2xl mb-4">
